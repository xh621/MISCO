...
if __name__ == "__main__":
    ...
    #env_tasks = ["BidirectionalWalker-v0","Carrier-v0","Catcher-v0"]#"Lifter-v0", "Hurdler-v0"]
    task_name_id_mapper = {}
    task_id_name_mapper = {}
    ...
    experiment_name = "CVAE_att4_task3try8_add3(noadv4, sim:0, seed:0,1: No MP)" + time.strftime("%Y-%m-%d-%H_%M_%S", time.localtime(time.time()))
