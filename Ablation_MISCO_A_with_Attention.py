...
if __name__ == "__main__":
    ...
    env_tasks = ["ObstacleTraverser-v0","GapJumper-v0","Traverser-v0"]#["Flipper-v0","Jumper-v0","Balancer-v0"]#["PlatformJumper-v0","GapJumper-v0","Traverser-v0"]
    task_name_id_mapper = {}
    task_id_name_mapper = {}
    ...
    experiment_name = "CVAE_att2_Ab_try8(adv,D,seed:0,1: no MP)" + time.strftime("%Y-%m-%d-%H_%M_%S", time.localtime(time.time()))
