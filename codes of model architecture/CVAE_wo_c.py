# This file defines the VAE model architecture in ablation experiment without task condition in approximate posterior
...
class VAE(nn.Module):
    ...
    def setup_networks(self):
        ...
        self.encoder_h = MLP([5*self.x_size**2]+self.hidden_sizes_p+[[self.h_emb, self.h_emb]],
                            activation=nn.ReLU,
