...
if __name__ == "__main__":
    ...
    #env_tasks = ["Catcher-v0", "Carrier-v0", "Pusher-v0"]
    ...
    experiment_name = "CVAE_att4_task3try8_add3(adv4,seed:0,1: no MP)" + time.strftime("%Y-%m-%d-%H_%M_%S", time.localtime(time.time()))
