...
#["PlatformJumper-v0","GapJumper-v0","Traverser-v0"]#["ObstacleTraverser-v0","GapJumper-v0","Traverser-v0"]#["PlatformJumper-v0","ObstacleTraverser-v0","Traverser-v0"] #"Jumper-v0""ObstacleTraverser-v0"["Flipper-v0","Jumper-v0","Balancer-v0"]#["PlatformJumper-v0","GapJumper-v0","Traverser-v0"]#["Flipper-v0","Jumper-v0","Balancer-v0"]# ["ObstacleTraverser-v0", "Hurdler-v0","PlatformJumper-v0"]
#env_tasks = ["Catcher-v0", "Carrier-v0", "Pusher-v0"]
    #env_tasks = ["Catcher-v0","Carrier-v0","Pusher-v0"]#"Lifter-v0", "Hurdler-v0"]
    task_name_id_mapper = {}
    task_id_name_mapper = {}
    ...
    experiment_name = "Ab_b_add3_CVAE_att4_wo_nca_coparam(noadv, sim:0, seed:0,1: No MP)" + time.strftime("%Y-%m-%d-%H_%M_%S", time.localtime(time.time()))
