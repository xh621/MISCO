...
if __name__ == "__main__":
    ...
    env_tasks = ["ObstacleTraverser-v0","GapJumper-v0","Traverser-v0"]#["Flipper-v0","Jumper-v0","Balancer-v0"]#["ObstacleTraverser-v0","GapJumper-v0","Traverser-v0"]#["PlatformJumper-v0","GapJumper-v0","Traverser-v0"]#["Flipper-v0","Jumper-v0","Balancer-v0"]
    task_name_id_mapper = {}
    task_id_name_mapper = {}
    ...
    #env_tasks = ["Catcher-v0", "Carrier-v0", "Pusher-v0"]
    #morphVAE_att4_add3(adv,D,sim0,seed:2,1: no MP)
    experiment_name = "VAE_att4_Ab_try8(adv,seed:0,1: no MP)" + time.strftime("%Y-%m-%d-%H_%M_%S", time.localtime(time.time()))
